...
function game(user, computer){
  ...
  console.log('4:', game('rock', computer));
...
console.log('6:', annoyingSong(51));
console.log('6:', annoyingSong(50));
